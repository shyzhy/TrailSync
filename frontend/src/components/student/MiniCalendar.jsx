...
// Leading nulls for the empty cells before the 1st, then the days, then trailing nulls to finish the week.
...
// At-a-glance current month with dots on `highlightDates` ('YYYY-MM-DD'); not a scheduler.
export default function MiniCalendar({ highlightDates = [] }) {
  ...
  return (
    <div className="ts-card p-5">
      ...
      {/* Without this legend, the dots are a puzzle. */}
