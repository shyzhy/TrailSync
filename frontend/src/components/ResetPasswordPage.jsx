...
import { API_BASE_URL, BusyLabel, FONT_SERIF, GlassScene, Spinner } from './trailsyncUI.jsx';
...
// The server's reason a link can't be used. Expired and used are one case:
// either way, the answer is a new link.
...
/**
 * /reset-password?uid=…&token=…&from=student|staff — where the reset email leads.
 *
 * The link is checked as soon as the page opens, so a dead one is explained
 * before anyone types a new password into it. A successful reset does not
 * sign the person in: they're sent to their login with a note, and log in
 * with the new password - which is also how they find out it worked.
 */
export default function ResetPasswordPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      // The link died while the form was open (used in another tab, or the
      // hour ran out): that's the expired page, not a form error.
