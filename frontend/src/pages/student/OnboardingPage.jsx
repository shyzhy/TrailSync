...
// The four steps and their opening words, warmer than the request form's: this is someone's first moment in the app.
const STEPS = [
  {
    n: 1,
    label: 'About you',
...
// Setup wizard after email confirmation. Each step saves on Continue, and the server's onboarding state decides where to resume.
export default function OnboardingPage() {
  ...
  return (
    <div className="ts-app-shell" style={FONT_SANS}>
      ...
      {/* No app navigation until setup is finished; Log out stays for shared computers. */}
              ...
              <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                {step === 4 && (
                  <div className="flex flex-col-reverse gap-3 sm:flex-row">
                    {/* Always visible: a photo must never stop someone finishing setup. */}
                    {!hasPhoto && (
                      <button
                        type="button"
                        onClick={() => go(DONE)}
