...
urlpatterns = [
    ...
    path('api/form-requests/<int:pk>/arrived/', FormRequestArrivedView.as_view(), name='form-request-arrived'),
    path('api/form-requests/<int:pk>/reschedule/', FormRequestRescheduleView.as_view(), name='form-request-reschedule'),
    ...
    path('api/registrar/pickup-desk/', RegistrarPickupDeskView.as_view(), name='registrar-pickup-desk'),
    path('api/registrar/queue/<int:pk>/missed-pickup/', RegistrarMissedPickupView.as_view(), name='registrar-missed-pickup'),
    path('api/registrar/queue/<int:pk>/reschedule/<str:decision>/', RegistrarRescheduleDecisionView.as_view(), name='registrar-reschedule-decision'),
